...
using static Android.Support.V4.App.FragmentTabHost;
using MvvmCross.Core.ViewModels;
using MvvmCross.Platform.Core;

namespace UrbanDictionary.Xamarin.Droid
{
    public abstract class MvxTabsAppCompatActivity : MvxAppCompatActivity, TabHost.IOnTabChangeListener
    {
        ...
        protected MvxTabsAppCompatActivity(int layoutId, int tabContentId)
        {
            _layoutId = layoutId;
            _tabContentId = tabContentId;
        }

        protected MvxTabsAppCompatActivity(IntPtr javaReference, JniHandleOwnership transfer) : base(javaReference, transfer)
        {
        }
        ...
        private static void AddTab(MvxTabsAppCompatActivity activity,
                                   TabHost tabHost,
        ...
        public virtual void OnTabFragmentChanging(string tag, Android.Support.V4.App.FragmentTransaction transaction)
        {
        }
